...
import cz.honestcity.service.rate.RateAuthorityGateway;
...
@HonestCityService(beanId = RateAuthorityGateway.class)
public class CzechNationalBankCrawling implements RateAuthorityGateway {
